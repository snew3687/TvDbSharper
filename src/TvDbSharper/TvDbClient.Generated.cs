...
namespace TvDbSharper
{
    ...
    public partial class TvDbClient
    {
        ...
        public Task<TvDbApiResponse<UserInfoDto[]>> UserInfoById(int id, CancellationToken cancellationToken)
        {
            return this.Get<UserInfoDto[]>($"user/{id}", null, cancellationToken);
        }

        public Task<TvDbApiResponse<UserInfoDto[]>> UserInfoById(int id)
        {
